...
//						// if in a browser,
//						var loc = null,
//							remote_name = remote_address+":"+remote_port;
//						if (remote_name in servers) {
//						}
//						else if (window 
//								&& (loc = window.location) 	// one =
//								&& loc.hostname == remote_address
//								&& remote_port == (loc.port || 80)
//								) {
//							handle.error = 0; // connected!
//							handle.peer = '888';
//						} else {
...
function ServerFactory(port,address) {
	...
	function makeServer() {
		...
		var server = http.createServer(function (req, res) {
			...
			try{
				xhr.open(req.method, req.url, /* async */true);
