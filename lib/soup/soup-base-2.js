...
function getFileContent(path, position, length){
	...
	xhr.addEventListener('load',function(ev){
		...
		console.log(444444444, ev, this.status, range, this.responseText.length,
...
function defer(cb /* ,args */){
	...
	setTimeout(function(){cb.apply(cb,args);}, POLL_INTERVAL );
}
...
var 
	setTimeout = //window.setTimeout, 
		(function() { var original = window.setTimeout; return function(){ arguments[1] += POLL_INTERVAL; original.apply(window, arguments) } })(),
